...
def get_most_popular_articles():
    ...
    WHERE l.path = concat('/article/',a.slug) GROUP BY a.title
...
def get_most_popular_author():
    ...
    log AS l WHERE l.path = concat('/article/', a.slug) GROUP BY a.author
